...
public class EmployeeController {
	...
	public String deleteEmployee(@PathVariable("id") long id) throws EmployeeDeleteException {
		Employee employeeToDelete = employeeDao.find(id);
		boolean wasDeleted = employeeDao.removeEmployee(employeeToDelete);
		
		if (!wasDeleted) {
			throw new EmployeeDeleteException(employeeToDelete);
		}
